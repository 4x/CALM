...
public class TestMarketMakerDeciderHistorical {
    ...
    public static void main(String[] _args) {
        ...
        try {
            ...
            marketMakerDeciderTrader.addAdvice(new MarketMakerPosition(time, 1.1845,  1.1800, 1.186,  1.17, time + 28*60*1000L));
            marketMakerDeciderTrader.setTime(time);
            marketMakerDeciderTrader.step();

            time = format.parse("2006.01.02 17:10:20").getTime();
            marketMakerDeciderTrader.addAdvice(new MarketMakerPosition(time, 1.1845,  1.18435, 1.186,  1.17, time + 28*60*1000L));
            marketMakerDeciderTrader.step();
